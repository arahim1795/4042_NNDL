...
def char_rnn_model_vanilla_2layer_gradient_clipping(train_data,test_data,keep_probability):
    # Create the model
    x = tf.placeholder(tf.int64, [None, MAX_DOCUMENT_LENGTH])
    y_ = tf.placeholder(tf.int64)
    ...
    gvs = train_op.compute_gradients(entropy)
    capped_gvs = [(tf.clip_by_value(grad, -2., 2.), var) for grad, var in gvs] # +/- 2 for threshold =2
    train_op = train_op.apply_gradients(capped_gvs)
...
def word_rnn_model_vanilla_2layer_gradient_clipping(train_data,test_data,keep_probability):
    # Create the model
    x = tf.placeholder(tf.int64, [None, MAX_DOCUMENT_LENGTH])
    y_ = tf.placeholder(tf.int64)
...
def char_rnn_model_LSTM_2layer_gradient_clipping(train_data,test_data,keep_probability):
    # Create the model
    x = tf.placeholder(tf.int64, [None, MAX_DOCUMENT_LENGTH])
    y_ = tf.placeholder(tf.int64)
...
def word_rnn_model_LSTM_2layer_gradient_clipping(train_data,test_data,keep_probability):
    # Create the model
    x = tf.placeholder(tf.int64, [None, MAX_DOCUMENT_LENGTH])
    y_ = tf.placeholder(tf.int64)
    ...
    train_op = tf.train.AdamOptimizer(learning_rate)
    gvs = train_op.compute_gradients(entropy)
    capped_gvs = [(tf.clip_by_value(gradient, -2., 2.), var) for gradient, var in gvs] # +/- 2 for threshold =2
    train_op = train_op.apply_gradients(capped_gvs)
...
def main():
    ...
    char_rnn_model_LSTM_2layer_data = char_rnn_model_LSTM_2layer(train_char,test_char,1)
    char_rnn_model_LSTM_2layer_gradient_clipping_data = char_rnn_model_LSTM_2layer_gradient_clipping(train_char,test_char,1)
    char_rnn_model_vanilla_2layer_data = char_rnn_model_vanilla_2layer(train_char,test_char,1)
    char_rnn_model_vanilla_2layer_gradient_clipping_data = char_rnn_model_vanilla_2layer_gradient_clipping(train_char,test_char,1)
    word_rnn_model_LSTM_2layer_data = word_rnn_model_LSTM_2layer(train_word,test_word,1)
    word_rnn_model_LSTM_2layer_gradient_clipping_data = word_rnn_model_LSTM_2layer_gradient_clipping(train_word,test_word,1)
    word_rnn_model_vanilla_2layer_data = word_rnn_model_vanilla_2layer(train_word,test_word,1)
    word_rnn_model_vanilla_2layer_gradient_clipping_data = word_rnn_model_vanilla_2layer_gradient_clipping(train_word,test_word,1)
    ...
    accuracy_list.append(char_rnn_model_vanilla_2layer_gradient_clipping_data[0])
    ...
    accuracy_list.append(word_rnn_model_vanilla_2layer_gradient_clipping_data[0])
    ...
    entropy_list.append(char_rnn_model_vanilla_2layer_gradient_clipping_data[1])
